    ...
    <div style={styles.content}>
      ...
      <div style={styles.card}>
        ...
        <ol style={styles.list}>
          ...
          <li style={styles.listItem}>Click the Neutralize icon in your toolbar</li>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  wordmark: { fontSize: '20px', fontWeight: '700', color: '#E8DDF0', letterSpacing: '4px', margin: '0 0 4px 0' },
  tagline: {
    fontSize: '9px',
    color: '#C8885A',
    letterSpacing: '2px',
  ...
  card: { backgroundColor: '#3A2A40', border: '1px solid #6A5478', borderRadius: '4px', padding: '14px' },
  cardLabel: { fontSize: '9px', fontWeight: '700', color: '#6A5478', letterSpacing: '2px', margin: '0 0 10px 0' },
  list: { margin: '0 0 10px 0', paddingLeft: '18px' },
  listItem: { fontSize: '12px', color: '#C8B8D8', marginBottom: '5px', lineHeight: '1.5', letterSpacing: '0.3px' },
